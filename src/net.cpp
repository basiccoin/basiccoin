...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Basiccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"basiccointools.com", "dnsseed.basiccointools.com"},
    {"basiccoinpool.org", "dnsseed.basiccoinpool.org"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Basiccoin is probably already running."), addrBind.ToString().c_str());
        else
